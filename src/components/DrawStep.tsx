      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cards.map((card, index) => (
          <div key={index} className="bg-slate-800 rounded-lg p-4 space-y-2">
            <div className={`aspect-[2/3] bg-gradient-to-br from-amber-900/50 to-slate-900 rounded flex items-center justify-center border border-amber-500/30 ${card.reversed ? 'rotate-180' : ''} transition-transform`}>
